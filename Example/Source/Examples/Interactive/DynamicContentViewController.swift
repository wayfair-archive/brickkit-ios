...
class DynamicContentViewController: BrickViewController {
    ...
    func hideSectionNested() -> BrickSection {
        let sectionLabelBrick = LabelBrick(backgroundColor: .brickGray3, dataSource: LabelBrickCellModel(text: "Section 0".uppercaseString, configureCellBlock: BaseBrickController.configureCell))
    ...
    func hideableSection() -> BrickSection {
        let brick = LabelBrick(height: .Auto(estimate: .Fixed(size:30)), backgroundColor: .brickGray3, text: "Section 1 Label 0".uppercaseString, configureCellBlock: BaseBrickController.configureCell)
        ...
        let brick0 = LabelBrick(height: .Auto(estimate: .Fixed(size:30)), backgroundColor: .brickGray3, text: "Section 1 Label 1".uppercaseString, configureCellBlock: BaseBrickController.configureCell)
