...
class HideBrickViewController: BrickApp.BaseBrickController {
    ...
    override func viewDidLoad() {
        ...
        let section = BrickSection(bricks: [
            LabelBrick(HideBrickViewController.Identifiers.SimpleBrick, backgroundColor: .brickGray3, dataSource: LabelBrickCellModel(text: "BRICK", configureCellBlock: BaseBrickController.configureCell)),
            hideBrickButton,
            BrickSection(HideBrickViewController.Identifiers.SimpleSection, backgroundColor: .brickGray3, bricks: [
                LabelBrick(width: .Ratio(ratio: 0.5), backgroundColor: .brickGray5, dataSource: LabelBrickCellModel(text: "BRICK", configureCellBlock: BaseBrickController.configureCell)),
                LabelBrick(width: .Ratio(ratio: 0.5), backgroundColor: .brickGray5, dataSource: LabelBrickCellModel(text: "BRICK", configureCellBlock: BaseBrickController.configureCell)),
                ]),
            hideSectionButton
