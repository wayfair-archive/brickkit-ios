...
class EmbeddedSpotlightSnapScrollingViewController: BaseScrollingViewController {
    ...
    override func viewDidLoad() {
        ...
        let section = BrickSection(bricks: [
            LabelBrick(height: .Fixed(size: notInSpotlightHeight), backgroundColor: .brickGray1, dataSource: LabelBrickCellModel(text: "Not in the spotlight".uppercased(), configureCellBlock: LabelBrickCell.configure)),
