...
class ImageURLBrickViewController: BrickViewController {
    ...
    override func viewDidLoad() {
        ...
        let section = BrickSection("RootSection", bricks: [
            LabelBrick("L1", height: .Fixed(size: 38), backgroundColor: .brickGray1, text: "Below is an image brick with fixed height", configureCellBlock: BaseBrickController.configureCell),
            ...
            LabelBrick("L1", height: .Fixed(size: 38), backgroundColor: .brickGray1, text: "Below is an image brick loaded dynamically", configureCellBlock: BaseBrickController.configureCell),
