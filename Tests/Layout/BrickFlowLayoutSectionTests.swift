...
class BrickFlowLayoutSectionTests: BrickFlowLayoutBaseTests {
    ...
    func testCreateLayoutWithThreeSectionsNested() {
        setDataSources(SectionsCollectionViewDataSource(sections: [2, 2, 2, 2]), brickLayoutDataSource: SectionsLayoutDataSource(widthRatios: [[CGFloat(1/4), CGFloat(3/4)], [0.5, 0.5], [1,1], [1,1]], heights: [[100, 0], [0, 0], [100, 100], [100, 100]], types: [[.brick, .section(sectionIndex: 1)], [.section(sectionIndex: 2), .section(sectionIndex: 3)], [.brick, .brick], [.brick, .brick]]))
    ...
    func testCreateLayoutWithThreeSectionsNestedWithEdgeInsets() {
        ...
        setDataSources(SectionsCollectionViewDataSource(sections: [2, 2, 2, 2]), brickLayoutDataSource: SectionsLayoutDataSource(widthRatios: [[CGFloat(1/4), CGFloat(3/4)], [0.5, 0.5], [1,1], [1,1]], heights: [[100, 0], [0, 0], [100, 100], [100, 100]], edgeInsets: [UIEdgeInsets.zero, customEdgeInsets, customEdgeInsets, customEdgeInsets], types: [[.brick, .section(sectionIndex: 1)], [.section(sectionIndex: 2), .section(sectionIndex: 3)], [.brick, .brick], [.brick, .brick]]))
