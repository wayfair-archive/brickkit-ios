...
public class Brick: CustomStringConvertible {
    ...
    /// Used to serve up content that can be shown after update content is shown. Defaults to nil
    public weak var placeholderContentSource: PlaceholderContentSource?
